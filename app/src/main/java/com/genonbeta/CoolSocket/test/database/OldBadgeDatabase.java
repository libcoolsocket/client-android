...
public class OldBadgeDatabase extends SQLiteOpenHelper
{
	...
	{
        database.execSQL("CREATE TABLE `" + TABLE_LIST + "` (`" + COLUMN_LIST_CLIENT + "` text NOT NULL, `" + COLUMN_LIST_MESSAGE + "` text NOT NULL, `" + COLUMN_LIST_ISRECEIVED + "` int NOT NULL)");
    }

    public void add(String ip, String message, boolean isReceived)
	{
	...
	{
        add(messageItem.client, messageItem.message, messageItem.isReceived);
    }

    public void getList(ArrayList<MessageItem> arrayList)
	{
        SQLiteDatabase readableDatabase = getReadableDatabase();
        Cursor query = readableDatabase.query(TABLE_LIST, new String[] {COLUMN_LIST_CLIENT, COLUMN_LIST_MESSAGE, COLUMN_LIST_ISRECEIVED}, (String) null, (String[]) null, (String) null, (String) null, (String) null);
