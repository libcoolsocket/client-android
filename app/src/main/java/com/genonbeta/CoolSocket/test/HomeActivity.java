...
public class HomeActivity extends AppCompatActivity
{
	...
	public boolean isMultiscreen()
	{
		...
		return !(supportFragmentManager.findFragmentById(R.id.main_pair_list_fragment) == null || supportFragmentManager.findFragmentById(R.id.main_template_list_fragment) == null);
	}
